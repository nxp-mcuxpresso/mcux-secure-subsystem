...
#define SAB_SUCCESS  (0) //((sab_ranking_t)0x57)
#define SAB_FAILURE ((sab_ranking_t)0xE9)
...
#define SAP_GET_SESSION_FLAG_PRIO(flag) \
    ((flag >> SAP_SESSION_PRIO_POS) & SAP_SESSION_PRIO_MSK)
...
#define SAB_GET_STATUS_REQ                         ((sab_command_t)0x11)
#define SAB_CLOSE_SESSION_REQ                      ((sab_command_t)0x12)
#define SAB_CONTEXT_FREE_REQ                       ((sab_command_t)0x13)
...
#define SAB_INIT_TUNNEL_CONTEXT_REQ                ((sab_command_t)0x3c)
#define SAB_TUNNEL_REQ                             ((sab_command_t)0x3d)
#define SAB_ASYMMETRIC_DH_DERIVE_KEY_REQ           ((sab_command_t)0x3e)
...
#define SAB_KEY_OBJECT_SET_ACCESS_REQ              ((sab_command_t)0x43)
#define SAB_KEY_OBJECT_SET_PURPOSE_REQ             ((sab_command_t)0x44)
#define SAB_KEY_OBJECT_SET_USER_REQ                ((sab_command_t)0x45)
#define SAB_KEY_STORE_ALLOCATE_REQ                 ((sab_command_t)0x46)
#define SAB_KEY_STORE_CONTEXT_INIT_REQ             ((sab_command_t)0x47)
#define SAB_KEY_STORE_SAVE_REQ                     ((sab_command_t)0x48)
#define SAB_KEY_STORE_LOAD_REQ                     ((sab_command_t)0x49)
#define SAB_KEY_STORE_SET_KEY_REQ                  ((sab_command_t)0x4a)
#define SAB_KEY_STORE_GENERATE_KEY_REQ             ((sab_command_t)0x4b)
#define SAB_KEY_STORE_GET_KEY_REQ                  ((sab_command_t)0x4c)
#define SAB_KEY_STORE_OPEN_KEY_REQ                 ((sab_command_t)0x4d)
#define SAB_KEY_STORE_FREEZE_KEY_REQ               ((sab_command_t)0x4e)
#define SAB_KEY_STORE_ERASE_KEY_REQ                ((sab_command_t)0x4f)
#define SAB_OPEN_SESSION_REQ                       ((sab_command_t)0x50)
...
#define SAB_MGMT_GET_LIFECYCLE_REQ                 ((sab_command_t)0x69)
#define SAB_MGMT_GET_PROPERTY_REQ                  ((sab_command_t)0x6a)
#define SAB_MGMT_GET_SOFTWARE_VERSION_REQ          ((sab_command_t)0x6b)
#define SAB_MGMT_IMPORT_SECRET_REQ                 ((sab_command_t)0x6c)
#define SAB_MGMT_INTEGRITY_CHECK_ENABLE_REQ        ((sab_command_t)0x6d)
#define SAB_MGMT_SET_HOST_ACCESS_PERMISSION_REQ    ((sab_command_t)0x6e)
#define SAB_MGMT_SET_PROPERTY_REQ                  ((sab_command_t)0x6f)
#define SAB_MGMT_SET_RETURN_FA_REQ                 ((sab_command_t)0x70)
#define SAB_MGMT_PING_REQ                          ((sab_command_t)0x71)
#define SAB_KEY_OBJECT_GET_HANDLE_REQ              ((sab_command_t)0x72)
