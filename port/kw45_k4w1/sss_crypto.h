...
typedef  struct sss_ecdh_p256_context_t {
    ecdhPrivateKey_t       PrivateKey;         /*!< The private key */
    ecdhPublicKey_t        OwnPublicKey;       /*! Own Public computed from PrivateKey */
...
*              i.e. 64 bytes LSB first.
*
* \param[out]  pOutDhKey Pointer to the location to store the ecdh DKKey X P256 ECP point.
*              i.e. 32 bytes LSB first.
*
*
********************************************************************************** */
